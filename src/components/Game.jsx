    ...
    render() {
        return (
            <div>
                ...
                <div className="line">
                    <div className="card" onClick={(e) => this.ImageAnime(13)}><img className={this.state.image13? "animIn" : ""} src={this.state.picture[3]}/></div>
                    <div className="card" onClick={(e) => this.ImageAnime(14)}><img className={this.state.image14? "animIn" : ""} src={this.state.picture[4]}/></div>
                    <div className="card" onClick={(e) => this.ImageAnime(15)}><img className={this.state.image15? "animIn" : ""} src={this.state.picture[5]}/></div>
                    <div className="card" onClick={(e) => this.ImageAnime(16)}><img className={this.state.image16? "animIn" : ""} src={this.state.picture[6]}/></div>
                </div>
            </div>
        );
    }
